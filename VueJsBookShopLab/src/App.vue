...
<div id="app">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
            <div class="row">
                ...
                <div class="navbar col text-left">
                    <span class="navbar-brand">Computer Science<br />Book Shop</span>
                </div>
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <ul class="navbar-nav mr-auto"  v-if="this.$route.name !== 'Login'">
                <li class="nav-item active">
                    <router-link class="nav-link" to="/books">Books <span class="sr-only">(current)</span></router-link> |
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" role="button" v-on:click="LogOut();">LogOut</a>
                </li>
            </ul>
